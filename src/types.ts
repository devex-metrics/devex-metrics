...
export interface MergedPRSummary {
   ...
   *
   * Rules 3 and 4 are only checked on the GraphQL collection path; the REST
   * fallback only checks rules 1 and 2 (PR-author login and merge-commit
   * trailers), so AI co-authorship via individual commits or PR-body text is
